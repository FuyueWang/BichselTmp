...
public:
  MyTrackerSD(const G4String& name, 
	      const G4String& hitsCollectionName, G4ThreeVector, DetectorConstruction*);
  MyTrackerSD(G4String, G4ThreeVector, G4RotationMatrix *);
  ~MyTrackerSD();
...
private:
  ...
  MyTrackerHitsCollection* hitsCollection;
  G4ThreeVector m_absolutePos; // Absolute position
  DetectorConstruction* m_gD; // Geo description !
